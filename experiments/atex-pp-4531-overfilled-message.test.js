...
// Три станка, у каждого день переполнен: 08:00 (480 мин) + хвост в 16:00 (30 мин) → день до 16:30
// при потолке 16:15, перебор +15 мин. Виновник — ВТОРОЕ задание дня.
...
(function () {
    ...
    assert(text.indexOf('16:30') !== -1 && text.indexOf('+15 мин') !== -1,
        '#4531-C: конец дня и перебор — как раньше');
})();
...
(function () {
    ...
    assert(Math.round(d.overMin) === 15 && Math.round(d.endMin) === 16 * 60 + 30,
        '#4531-D: минуты перебора и конец дня прежние (регресс #4408)',
