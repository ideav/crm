...
(function () {
    // #4542: у продолжения есть ХРАНИМОЕ место в дне 0 (08:00) — оно стои́т перед 🔒 дня 1, значит
    // запрет обгона замка (решение заказчика 31.07.2026) его не касается и проверяется именно то,
    // ради чего написан блок: чем открывается день с 🔒. Без хранимого места задание считалось бы
    // новым и по новому правилу начиналось бы только после замка.
    var cont = cut('646473', '1241', 'OUT', '74922', K([[110, 2], [55, 12]]), 110, 12, false, 0);
