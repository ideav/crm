...
//   4: {60,60} A — наладка ножей (уширение полос 1→2 → 30 + доплата KNIVES_INCREASE 50 = 80)
...
eq(view.window.knifeMin, 80, 'минут наладки ножей: 80 (уширение полос → 30 + доплата 50)');
