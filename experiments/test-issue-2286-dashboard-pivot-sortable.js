...
const code = [
    ...
    'dashReadPivotControlsState',
    'dashSetPivotControlsVisible',
    'dashPivotHasConfiguredOptions',
    'dashPivotControlsAutoOpened',
    'dashSetPivotControlsAutoOpened',
    'dashShouldAutoOpenPivotControls',
    'dashMarkPivotRendererArea',
    'dashEnsurePivotSettingsToggle',
    'dashRefreshPivotControls',
