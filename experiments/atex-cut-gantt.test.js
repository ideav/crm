...
assertEqual(cuts, [
    { id: '10', number: '06.05.2026', planDate: '06.05.2026', status: 'В работе',
      ...
      materialId: '5', materialName: 'MR194', materialAlt: '', winding: 'OUT', storedKnifeMin: null, storedMaterialMin: null, cutTimeMin: null, slitter: { id: '101', label: 'Станок 1' } },
    { id: '20', number: '27.05.2026', planDate: '27.05.2026', status: 'Ожидает',
      ...
      materialId: '', materialName: '', materialAlt: '', winding: '', storedKnifeMin: null, storedMaterialMin: null, cutTimeMin: null, slitter: { id: null, label: '' } }
...
assertEqual(gantt.cutBarTime({ planDate: '2026-06-10 08:00', startDate: '2026-06-10 08:05', endDate: '2026-06-10 09:05' }),
    '08:00-08:30 (30 мин)', 'cutBarTime #4334: привязан к плану, факт (08:05/09:05) не двигает');
...
// ── cutSetupMin (#3675 п.3): минуты наладки по плану (#4334 — и у начатых/завершённых) ──
...
assertEqual(gantt.cutSetupMin({ planDate: '2026-06-10 08:00', startDate: '2026-06-10 08:05',
    ...
    { knife: 30, material: 15, total: 45 }, 'cutSetupMin #4334: начатая — наладка по плану');
...
// #4334: начатая резка показывается ПО ПЛАНУ — наладка на месте (факт геометрию не меняет).
assertEqual(gantt.cutBarSegments({ planDate: '2026-06-10 08:00', startDate: '2026-06-10 08:00',
    ...
    { knifePx: 60, materialPx: 30, cutPx: 60, totalPx: 150, knifeMin: 30, materialMin: 15, setupMin: 45 },
    'cutBarSegments #4334: начатая — наладка по плану');
...
assertEqual(gantt.cutBarMinutes({ planDate: '2026-06-10 08:00', startDate: '2026-06-10 08:00', endDate: '2026-06-10 08:40', leaderMin: 16 }), 46,
    'cutBarMinutes #4334: у начатой — плановое окно(30)+лидер(16), факт не растягивает');
...
var laidDone = gantt.layoutGroups(doneThenNext, gantt.ganttRange('2026-06-10', 'day'),
    gantt.parseDateTimeMs('2026-06-10 07:00'), {}, { pxPerMin: 1 });
assertEqual(laidDone.groups[0].tasks[0].widthPx, 30,
    'layoutGroups #4334: завершённое задание показано по плану (факт. финиш не растягивает)');
