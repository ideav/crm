...
// Схема и форма строки сверены с боевой ateh: `metadata/673803` отдаёт ровно этот
// объект, а запись из `object/673803/?JSON_OBJ&F_673803={токен}` приходит как
// {"i":…,"u":1,"o":1,"r":["{токен}","{имя}"]} — токен в r[0], имя в r[1].
var PAD_TABLE = {
