...
(function () {
    ...
    assertEqual(maxDays(res.loadBefore), 3, '#3848 старт: С4 на 3 дня (перегруз; #3968 реальная укладка — одинаковые конфиги группируются: 45 + 8×150 = 1245 → 3 дня, не 8×195)');
