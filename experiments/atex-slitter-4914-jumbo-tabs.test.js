...
(function() {
    ...
    // RATCHET-OK (#5005): «Кол-во резок» записи копится отметками прохода, поэтому
    // автосейв везёт и его — набор полей расширен решением заказчика (#5005).
    assertEqual(input.fields, {
        't82382': '6', 't82384': '7', 't82386': '8', 't791708': '9', 't82378': '3'
    }, 'jumboInputFields: автосейв везёт расход, списание, браки и резки (#5005) — без гл. значения (#4925)');
})();
