...
// ── Без firstPartId цепочки НЕТ (решение заказчика 31.07.2026): удаление сносит одну запись, а не
//    «похожую» соседку. Прежде их склеивала эвристика «сигнатура + смежные дни + заказ». ──────────
(function () {
    ...
    eq(chain(cuts, 'L1'), ['L1'], '#4292: без маркера сносится только сама запись — соседка по конфигурации не её звено');
})();
