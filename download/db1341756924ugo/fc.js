...
(function(){
  ...
  // Таблицы «Дуэль» (1341) и подчинённая «Участник дуэли» (1353) созданы в базе
  // db1341756924ugo. ID типов/реквизитов ниже. Для новой базы очистите FC.DUEL_CFG
  // (null) — сработает setup-панель с мастером создания таблиц.
  FC.DUEL_CFG = {t:1341, tp:1353,
    w:{cap:1342, match:1343, vid:1344, stake:1346, stat:1348, res:1350, dt:1352},
    wp:{mem:1354, pred:1356, result:1358}};
