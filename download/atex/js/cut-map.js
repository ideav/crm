...
(function(root, factory) {
    ...
    // #3242: в «Партии ГП» количество — «Кол-во рулонов» (было «Количество» у «Полосы»);
    // «Назначение» в «Партии ГП» нет → purpose best-effort (пусто).
    var STRIP_REQ = { width: 'Ширина, мм', qty: 'Кол-во рулонов', purpose: 'Назначение' };
