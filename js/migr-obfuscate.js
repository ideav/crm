 ...
 *   3. Суммы — умножаются на случайное число от 0.5 до 15 и обрезаются до 3 знаков справа.
...
(function(root){
    ...
    // rule 3: sum × random(0.5..15), результат обрезается до 3 знаков после запятой.
    ...
    function obfuscateSum(val, rng){
        ...
        var res = Math.trunc(n * factor * 1000) / 1000; // обрезаем до 3 знаков справа
        return String(res);
    }
