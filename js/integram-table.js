            ...
            modal.innerHTML = `
                ...
                <div class="column-settings-list">
                    <div class="table-settings-item">
                        ...
                        ${ this.getDataSourceType() === 'table' && (this.objectTableId || this.options.tableTypeId) ? `<a href="/${dbName}/object/${ this.objectTableId || this.options.tableTypeId }" style="margin-left: 10px;">Перейти в старый интерфейс</a>` : '' }
                    </div>
