...
несколько — по одному на каждый джамбо, из которого резали (пульт переключает их закладками,
#4914). Главное значение — сам номер джамбо (SHORT): его видит упаковщик (плашка в РМ
