...
| Кол-во резок | 82378 | SHORT | Факт («Кол-во резок факт»), без него — план |
...
счётчик и число резок. На задании без записей номер подставляется из памяти планшета по виду
сырья. Расход без номера джамбо не сохраняется. Реквизиты в схеме типа SHORT — метры хранятся
строкой.
