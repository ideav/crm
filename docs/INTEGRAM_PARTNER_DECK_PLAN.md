...
- **Визуал:** ![Диаграмма Ганта — план резки по станкам в Интеграме](screenshots/issue-3668-gantt-realtime.png)
...
- **Визуал:** пример дашборда руководителя и коннектор-источник (1С) в Интеграме:
  ![Дашборд руководителя в Интеграме](screenshots/issue-3002-09-director-dashboards.png)
...
- **Визуал:** _скриншот проекта — приложить_ (`screenshots/deck-4273/case-3-vending-mobile.png`): мокап телефона с карточкой аппарата, списком задач и сводкой статистики; плашка «рутина → 0».
...
- **Визуал:** _скриншот проекта — приложить_ (`screenshots/deck-4273/case-4-recruiting.png`): воронка этапов найма + счётчики (35 польз. · 85k вакансий · 200–300/нед).
...
- **Визуал:** _скриншот проекта — приложить_ (`screenshots/deck-4273/case-5-drone-twin.png`): граф экосистемы (узлы-участники и связи) с панелью динамических метрик.
...
8. **Добавлен раздел «Решения» (слайды 13–18):** слайд-обзор + пять кейсов-слайдов, по одному на проект — планирование производства (оптимизатор плана резки, скриншот Ганта), единый дэшборд из 13 закладок с кросс-валидацией (скриншоты дашборда и коннектора 1С), мобильное РМ вендинга воды, поточный рекрутинг (35 человек одновременно, 85 тыс. вакансий с HH.ru, набор 200–300 чел/нед) и «Дронономика» (цифровой двойник беспилотной отрасли на онтологиях). Каждый кейс привязан к формату решения (слайд 20) и к одному из двух направлений (слайд 4); реальные скриншоты приложены для планирования и дэшборда, для остальных кейсов — слоты под скриншоты проектов (`docs/screenshots/deck-4273/`).
