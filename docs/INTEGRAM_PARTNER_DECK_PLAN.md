...
### Слайд 16 — Модель монетизации (как зарабатывает партнёр)
...
- **Акцент для партнёра:** маржа на внедрении и поддержке остаётся у партнёра; чеки проектов — 37,5 тыс – 500 тыс ₽ (слайд 14); платформа — рекуррентная подписка снизу. Два направления = два потока сделок (частые сателлиты в корпорациях + крупные ключевые системы в МСБ).
...
- **Визуал:** график выручки по месяцам (история) + TAM/SAM/SOM-круги + таймлайн вех 2025–26 (КП ВТБ/ГПН · реестр Минцифры ноя-2025 · on-prem/ИИ).
