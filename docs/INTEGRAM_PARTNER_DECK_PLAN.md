...
> **Объём:** 17 основных слайдов + приложение. Ниже для каждого: цель, заголовок-мысль, контент,
...
### Слайд 13 — Форматы решения (что продавать и по какому чеку)
...
### Слайд 14 — Конкуренты: матрица позиционирования
...
### Слайд 15 — Модель монетизации (как зарабатывает партнёр)
...
- **Акцент для партнёра:** маржа на внедрении и поддержке остаётся у партнёра; чеки проектов — 37,5 тыс – 500 тыс ₽ (слайд 13); платформа — рекуррентная подписка снизу. Два направления = два потока сделок (частые сателлиты в корпорациях + крупные ключевые системы в МСБ).

### Слайд 16 — Финансовая модель и трекшн
...
### Слайд 17 — Команда, пруфы, оффер партнёру
...
- Разбор кейсов слайда 13 подробнее (скриншоты, ТЗ, чек).
...
2. **Введены два направления (слайд 4)** как сквозная линия: *замена Excel* (сателлиты, заход в корпорации) и *замена ключевой системы* (производство, планирование, CRM, ERP — заход в МСБ). Привязаны к сегментам и к форматам решения (слайд 13).
