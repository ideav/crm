...
> **Объём:** 19 основных слайдов + приложение. Ниже для каждого: цель, заголовок-мысль, контент,
...
### Слайд 13 — Решения: реальные проекты на Интеграме
- **Цель:** от «как это выглядит» (слайд 12) перейти к «что уже сделано» — показать партнёру боевые внедрённые решения разного класса как доказательство: платформа тянет и сателлиты, и ключевые системы, и уникальные задачи вроде цифрового двойника отрасли. Это референсы под форматы решения (слайд 15) и оба направления (слайд 4).
- **Заголовок:** Не демо, а работающие системы — от планирования производства до цифрового двойника отрасли.
- **Кейсы (задача → что сделали → эффект):**
  1. **Планирование производства (резка).** Планирование и перепланирование 5–7 дней производства занимало **3 рабочих дня** ручного труда. Сделали приложение, которое строит оптимальный план по множеству факторов с их весами: минимизация времени переналадки станков, смены сырья и упорядочивание операций с учётом физиологии человека и технических особенностей станков и сырья. *Живой пример — сам этот CRM на Интеграме (github.com/ideav/crm).* → направление «ключевая система».
  2. **Единый дэшборд руководителя.** Вместо разрозненных материалов, которые отделы приносили на оперативку, — **дэшборд из 13 закладок** (по каждому отделу + инвесторские + сводная). Сбор данных автоматический из **Битрикс24 и Google Sheets**, загрузка из **1С/Excel**, ручной ввод там, где автоматизация нецелесообразна; кросс-валидация и единый ввод. Полностью устранён дублирующий ввод, включён автоматический контроль полноты данных. → направление «замена Excel» (сателлит вокруг ядра).
  3. **Мобильное рабочее место оператора (вендинг воды).** Контроль и обслуживание автоматов с водой с телефона. Излишние рутинные действия — копирование данных, планирование задач, сбор отчётов и статистики аппаратов — **сведены к нулю**. → направление «ключевая система» (операционное ядро сервисной компании).
  4. **Поточный рекрутинг.** Предельная унификация сократила срок и стоимость разработки до **1 месяца**: аналитик правит логику и схему данных и сразу тестирует онлайн — цикл разработки ужимается до минут. Через месяц **35 человек работали в системе одновременно**, обработано **85 тыс. вакансий** с HH.ru; 100% кастомизация обеспечила поточный набор **200–300 человек в неделю без единого лишнего клика**. → направление «ключевая система» (найм как ядро бизнеса).
  5. **Дронономика — цифровой двойник отрасли.** В Интеграм загружены онтологии беспилотной отрасли, федеральной структуры управления, экономических и производственных составляющих. Получили точный и отзывчивый к изменениям **цифровой двойник отрасли** с моделированием взаимодействия всех участников экосистемы и **динамическим расчётом параметров**: экономика, рейтинги, события, метрики. → уникальный класс задач (онтологии + граф), недоступный конструкторам.
- **Мысль для партнёра:** это не «может сделать», а **уже сделано и работает** — конкретные референсы, которые вы показываете своему заказчику. Каждый кейс ложится в один из форматов слайда 15 и в одно из двух направлений слайда 4; вместе они закрывают весь спектр — от Excel-сателлита до ключевой системы и уникального цифрового двойника.
- **Визуал:** 5 карточек-кейсов (иконка отрасли · «было → стало» · ключевая цифра), сгруппированы по двум направлениям; плашка-рефрен «Внедрено и работает».
- **Пруф/источник:** боевой репозиторий планирования производства — github.com/ideav/crm; остальные кейсы — демо и доступ к проектам по запросу партнёра.

### Слайд 14 — Безопасность, замкнутый контур и отказоустойчивость
...
### Слайд 15 — Форматы решения (что продавать и по какому чеку)
...
### Слайд 16 — Конкуренты: матрица позиционирования
...
### Слайд 17 — Модель монетизации: где здесь партнёр и как он зарабатывает
...
- **Что значит «партнёр зарабатывает на проектах заказчика»:**
  - Партнёр **инициирует и одобряет** сделку и отдаёт её адепту — тот собирает решение на Интеграме (чек от 150 тыс до 5 млн ₽, слайд 15) и ведёт поддержку. Платформе идёт только плата за инструмент (подписка **от 1 950 ₽/мес** или лицензия **590 тыс ₽/год**) — это стоимость платформы, **а не комиссия с проекта**. Партнёр получает **свою долю, не занимаясь реализацией**.
...
### Слайд 18 — Финансовая модель и трекшн
...
### Слайд 19 — Команда, пруфы, оффер партнёру
...
- **Оффер партнёру (что вы получаете):**
  ...
  - Обучение и сертификация ваших адептов; внедряют и держат поддержку они — вы **даёте канал и одобряете сделки** (см. слайд 17).
  - Готовые форматы решений и референс-проекты для быстрого старта (слайд 15).
...
- Разбор кейсов слайда 15 подробнее (скриншоты, ТЗ, чек).
...
2. **Введены два направления (слайд 4)** как сквозная линия: *замена Excel* (сателлиты, заход в корпорации) и *замена ключевой системы* (производство, планирование, CRM, ERP — заход в МСБ). Привязаны к сегментам и к форматам решения (слайд 15).
...
6. **Добавлен слайд «Безопасность, замкнутый контур и отказоустойчивость» (слайд 14):** on-prem/air-gap, ролевая модель на сервере, JWT/LDAP/AD/SSO, георезерв/репликация/PITR, RPO/RTO по SLA, 152-ФЗ/КИИ/223-ФЗ/44-ФЗ — под требования крупного заказчика и его службы ИБ. Усилены строки матрицы конкурентов (on-prem + замкнутый контур).
7. **Слайд монетизации (17) переписан под вопрос «где здесь партнёр»:** карта ролей (платформа / партнёр / адепт / заказчик — кто что делает и на чём зарабатывает) и расшифровка «партнёр зарабатывает на проектах заказчика» на цифрах. Роль партнёра — **канал и одобрение сделок без операционной нагрузки**: он приводит заказчиков и одобряет сделку, а внедряют, поддерживают и отвечают за результат адепты; плата платформе — за инструмент, а не комиссия с проекта.
8. **Добавлен слайд «Решения: реальные проекты на Интеграме» (слайд 13):** пять боевых референсов — планирование производства (оптимизатор плана резки), единый дэшборд из 13 закладок с кросс-валидацией, мобильное РМ вендинга воды, поточный рекрутинг (35 человек одновременно, 85 тыс. вакансий с HH.ru, набор 200–300 чел/нед) и «Дронономика» (цифровой двойник беспилотной отрасли на онтологиях). Каждый кейс привязан к формату решения (слайд 15) и к одному из двух направлений (слайд 4) — превращает абстрактные «форматы» в проверяемые внедрения.
