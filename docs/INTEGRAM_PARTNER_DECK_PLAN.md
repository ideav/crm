...
- **Пруф/источник:** живой пример — сам этот CRM построен на Интеграме; боевой репозиторий github.com/ideav/crm (3700+ тикетов).
...
2. **Введены два направления (слайд 4)** как сквозная линия: *замена Excel* (сателлиты, заход в корпорации) и *замена ключевой системы* (производство, планирование, CRM, ERP — заход в МСБ). Привязаны к сегментам и к форматам решения (слайд 20).
...
6. **Добавлен слайд «Безопасность, замкнутый контур и отказоустойчивость» (слайд 19):** on-prem/air-gap, ролевая модель на сервере, JWT/LDAP/AD/SSO, георезерв/репликация/PITR, RPO/RTO по SLA, 152-ФЗ/КИИ/223-ФЗ/44-ФЗ — под требования крупного заказчика и его службы ИБ. Усилены строки матрицы конкурентов (on-prem + замкнутый контур).
7. **Слайд монетизации (22) переписан под вопрос «где здесь партнёр»:** карта ролей (платформа / партнёр / адепт / заказчик — кто что делает и на чём зарабатывает) и расшифровка «партнёр зарабатывает на проектах заказчика» на цифрах. Роль партнёра — **канал и одобрение сделок без операционной нагрузки**: он приводит заказчиков и одобряет сделку, а внедряют, поддерживают и отвечают за результат адепты; плата платформе — за инструмент, а не комиссия с проекта.
8. **Добавлен раздел «Решения» (слайды 13–18):** слайд-обзор + пять кейсов-слайдов, по одному на проект — планирование производства (оптимизатор плана резки, скриншот Ганта), единый дэшборд из 13 закладок с кросс-валидацией (скриншоты дашборда и коннектора 1С), мобильное РМ вендинга воды, поточный рекрутинг (35 человек одновременно, 85 тыс. вакансий с HH.ru, набор 200–300 чел/нед) и «Дронономика» (цифровой двойник беспилотной отрасли на онтологиях). Каждый кейс привязан к формату решения (слайд 20) и к одному из двух направлений (слайд 4). Все пять кейсов проиллюстрированы реальными скриншотами (`docs/screenshots/deck-4273/`): планирование (Гант + очередь с «Качеством плана») и дэшборд из 13 закладок — из рабочих баз; вендинг воды (десктоп + два мобильных экрана) и рекрутинг (воронка HH.ru + карточка кандидата) — из деки «Распак»; цифровой двойник — «Дронономика».
