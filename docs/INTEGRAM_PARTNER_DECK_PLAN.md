...
- **Трекшн — история (слайд 12 «Распак»):** выручка 2022 → 2023 → 2024 = **0,2 → 0,7 → 3,1 млн ₽** (×4–5 в год); 70 активных клиентов РФ/СНГ; 5 лицензий продано; 5 партнёров + 7 адептов зарабатывают; +300 адептов; финалист/победитель SberUp; Продукт недели #1 Product Radar.
...
- **Оффер партнёру (что вы получаете):**
  ...
  - Гибкие модели сотрудничества: реселлер / внедренческий партнёр / стратегический партнёр.
...
- **Контакты:**
  ...
  - Сайт: **integram.io** (и ideav.ru) · Документация: **help.integram.io**
