...
- **«Упаковано» на каждую позицию (#5011):** у каждой строки описания много-позиционной
  плашки — своя кнопка **«Упаковано»** (в хвосте строки, рядом с количеством): клик
  отмечает **только эту позицию** её текущим количеством — «Упаковано шт» в её Партию ГП
  и событие «Упаковка»; у упакованной строки кнопки нет, схлопнувшиеся дубликаты-строки
  кнопка пакует по одной за клик. Плашка остаётся в статусе «частично», пока не отмечены
  остальные позиции, бейдж показывает остаток. Одиночной плашке строковая кнопка не
  нужна — «Упаковано» карточки и есть эта позиция (#4680).
