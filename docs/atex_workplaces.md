...
- **Что видит упаковщик:** задание попадает в список, **как только по нему сделана первая
  ...
  (колонка `jumbo`, #4910, `.atex-pk-jumbo`) — номер джамбо 787045 у «Задания в
  производство», проставляется при отметке резки. Обе колонки бывают пустыми, тогда
  карточка просто без соответствующей плашки. Справа количество и кнопка. Когда у одного задания несколько позиций, над ними
