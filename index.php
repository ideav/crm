...
define("TOKEN", 125);
define("SECRET", 130);
define("VERSION", 112);  # ОБЩАЯ cache-bust версия ассетов (?{_global_.version}); бить при правках js/css — один бамп обновляет все ассеты с ?{_global_.version} (#3418). main.html несёт КОМБИНИРОВАННУЮ ?{_global_.version}.<локальная> — локальный суффикс бьётся в самом main.html для сброса кэша ОДНОЙ базы без правки ядра (#4043)
